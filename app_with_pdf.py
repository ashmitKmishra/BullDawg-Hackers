"""
Compatibility shim for deployments expecting `app_with_pdf:app`.
This module simply re-exports the Flask `app` object from `main.py` so
old start commands like `gunicorn app_with_pdf:app` continue to work.
"""
